...
export function HeroView({ sources }: HeroViewProps) {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative flex h-[90svh] flex-col overflow-hidden bg-[#050505]"
    >
      <div aria-hidden className="absolute inset-0">
        ...
        <HeroVideos
          ...
          panTargetRef={sectionRef}
        />
        <div className="pointer-events-none absolute inset-0 z-[2] bg-gradient-to-t from-[#050505]/70 via-transparent to-[#050505]/25" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-1 flex-col items-center justify-center px-6 py-16 text-center sm:px-10">
        <div ref={contentRef} className="flex w-full max-w-3xl flex-col items-center">
